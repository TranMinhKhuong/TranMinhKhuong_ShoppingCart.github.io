...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading" style="background: aquamarine;">

					<h4>Product Management</h4>

				</div>

				<div class="panel-body" style="background: bisque;">
	...
	<hr/>	
	<h1 color: brown;>Manager Products</h1>
	<hr/>
	
	<div class="row">
		<div class='col-xs-12'>
		
			<table id="productsTable" class="table table-condensed table-bordered" style="background: honeydew;">
